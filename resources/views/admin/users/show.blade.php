...
<head>
    ...
    <title>RenaultOcaz - Détails de l'Utilisateur</title>
    <!-- Fonts -->
    ...
    <div class="container container-main">
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.users.edit', $user) }}" class="btn-header btn-warning">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-person"></i> Informations de l'Utilisateur
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <tr>
                            ...
                            <tr>
                                <th>Entreprise:</th>
                                <td>{{ $user->entreprise->nom ?? 'Aucune entreprise' }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="card-body">
                        @if($user->role === 'vendeur')
                            <div class="mb-3">
                                ...
                                <p class="display-6">{{ $user->demandesTraitees->count() }}</p>
                            </div>
                            <div class="mb-3">
                                <h6>Ventes réalisées:</h6>
                                <p class="display-6">{{ $user->ventes->count() }}</p>
                            </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-building"></i> Informations sur l'Entreprise
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Adresse:</th>
                                        <td>{{ $user->entreprise->adresse ?? 'Non spécifiée' }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <table class="table">
                                    <tr>
                                        <th>Téléphone:</th>
                                        <td>{{ $user->entreprise->telephone ?? 'Non spécifié' }}</td>
                                    </tr>
                                    <tr>
                                        <th>Nombre d'employés:</th>
                                        <td>{{ $user->entreprise->users->count() }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
