...
<head>
    ...
    <title>RenaultOcaz - Détails de l'Entreprise</title>
    <!-- Fonts -->
    ...
    <div class="container container-main">
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.entreprises.edit', $entreprise) }}" class="btn-header btn-warning">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>{{ $entreprise->updated_at->format('d/m/Y H:i') }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <p class="display-6">{{ $entreprise->users->count() }}</p>
                        </div>
                        <div class="mb-3">
                            <h6>Voitures en stock:</h6>
                            <p class="display-6">{{ $entreprise->voitures->count() }}</p>
                        </div>
                        <div class="mb-3">
                            <h6>Ventes réalisées:</h6>
                            @php
                                $totalVentes = 0;
                                foreach($entreprise->voitures as $voiture) {
                                    $totalVentes += $voiture->ventes->count();
                                }
                            @endphp
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-people"></i> Employés ({{ $entreprise->users->count() }})
                    </div>
                    <div class="card-body">
                        ...
                        @else
                            <p class="text-center text-muted">Aucun employé dans cette entreprise</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-car-front"></i> Voitures en stock ({{ $entreprise->voitures->where('statut', 'disponible')->count() }})
                    </div>
                    <div class="card-body">
                        @if($entreprise->voitures->where('statut', 'disponible')->count() > 0)
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($entreprise->voitures->where('statut', 'disponible')->take(5) as $voiture)
                                            <tr>
                                ...
                                @if($entreprise->voitures->where('statut', 'disponible')->count() > 5)
                                    <p class="text-center">
                                        <a href="{{ route('admin.voitures.index') }}?entreprise={{ $entreprise->id }}">Voir toutes les voitures ({{ $entreprise->voitures->where('statut', 'disponible')->count() }})</a>
                                    </p>
                                @endif
                            </div>
                        @else
                            <p class="text-center text-muted">Aucune voiture en stock</p>
                        @endif
                    </div>
                </div>
            </div>
