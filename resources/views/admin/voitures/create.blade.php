...
<head>
    ...
    <title>RenaultOcaz - Ajouter une voiture</title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="container container-main">
        <div class="page-header">
            <h1 class="page-title">Ajouter une voiture d'occasion</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.voitures.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="marque" id="marque" class="form-control @error('marque') is-invalid @enderror" value="{{ old('marque') }}" required>
                                @error('marque')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="modele" id="modele" class="form-control @error('modele') is-invalid @enderror" value="{{ old('modele') }}" required>
                                @error('modele')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="annee" id="annee" class="form-control @error('annee') is-invalid @enderror" value="{{ old('annee') }}" min="1900" max="{{ date('Y') + 1 }}" required>
                                @error('annee')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="kilometrage" id="kilometrage" class="form-control @error('kilometrage') is-invalid @enderror" value="{{ old('kilometrage') }}" min="0" required>
                                @error('kilometrage')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="prix" id="prix" class="form-control @error('prix') is-invalid @enderror" value="{{ old('prix') }}" min="0" required>
                                @error('prix')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <select name="statut" id="statut" class="form-select @error('statut') is-invalid @enderror" required>
                                    ...
                                    <option value="en_vente" {{ old('statut') == 'en_vente' ? 'selected' : '' }}>En vente</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="etat_diagnostic" id="etat_diagnostic" class="form-control @error('etat_diagnostic') is-invalid @enderror" rows="3">{{ old('etat_diagnostic') }}</textarea>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" name="promotion" id="promotion" class="form-check-input" {{ old('promotion') ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="prix_promotion" id="prix_promotion" class="form-control" value="{{ old('prix_promotion') }}" min="0">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="date_fin_promotion" class="form-label">Date de fin de promotion</label>
                                    <input type="date" name="date_fin_promotion" id="date_fin_promotion" class="form-control" value="{{ old('date_fin_promotion') }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (promotionCheckbox) {
                ...
                togglePromotionFields(); // Appel initial
            }
