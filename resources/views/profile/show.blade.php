...
<head>
    ...
    <title>RenaultOcaz - Mon Profil</title>
    <!-- Fonts -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <!-- Bouton Retour (visible seulement sur mobile en premier, puis toujours visible) -->
    ...
    <div class="container container-main">
        <h1 class="text-center page-title">Mon Profil</h1>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('profile.update') }}">
                            ...
                            <p class="text-muted">Laissez ces champs vides si vous ne souhaitez pas modifier votre mot de passe.</p>
