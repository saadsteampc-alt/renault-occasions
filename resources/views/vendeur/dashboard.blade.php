...
<head>
    ...
    <title>RenaultOcaz - Tableau de bord Vendeur</title>
    <!-- Fonts -->
        ...
        <div class="row">
            <div class="col-md-3 mb-4">
                <div class="stats-card bg-primary">
                    <h5 class="card-title"><i class="bi bi-car-front"></i> Total Voitures</h5>
                    <p class="card-text">{{ $totalVoitures }}</p>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="stats-card bg-warning">
                    <h5 class="card-title"><i class="bi bi-clipboard-check"></i> Mes Demandes</h5>
                    <p class="card-text">{{ $mesDemandes }}</p>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="stats-card bg-success">
                    <h5 class="card-title"><i class="bi bi-cash-stack"></i> Mes Ventes</h5>
                    <p class="card-text">{{ $mesVentes }}</p>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="stats-card bg-info">
                    <h5 class="card-title"><i class="bi bi-graph-up"></i> Taux Conversion</h5>
                    <p class="card-text">
                        @if($mesDemandes > 0)
                            {{ round(($mesVentes / $mesDemandes) * 100) }}%
                        @else
                            0%
                        @endif
                    </p>
                                    ...
                                    <tbody>
                                        @foreach($recentDemandes as $demande)
                                            <tr>
                                                ...
                                                <td>{{ $demande->voiture->marque }} {{ $demande->voiture->modele }} ({{ $demande->voiture->annee }})</td>
                                                <td>
