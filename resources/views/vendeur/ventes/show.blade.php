...
<head>
    ...
    <title>RenaultOcaz - Détails de la Vente</title>
    <!-- Fonts -->
...
.btn-header.btn-primary i {
    color: white !important; /* pour l’icône */
}
    ...
    <div class="container container-main">
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('vendeur.ventes.index') }}" class="btn-header btn-secondary">
                    <i class="bi bi-arrow-left"></i> Retour à la liste
                </a>
                <a href="{{ route('vendeur.ventes.pdf', $vente) }}" class="btn-header btn-primary" target="_blank">
                    <i class="bi bi-file-earmark-pdf"></i> Générer un reçu PDF
                </a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="bi bi-car-front"></i> Véhicule concerné
                    </div>
                    <div class="card-body">
                        @if($vente->voiture)
                            <div class="d-flex">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-file-pdf"></i> Reçu de vente
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <i class="bi bi-file-earmark-pdf" style="font-size: 3rem; color: #dc3545;"></i>
                            <p class="mt-2">
                                <a href="{{ asset('storage/' . $vente->pdf_recue) }}" target="_blank" class="btn btn-danger">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p class="text-muted">Aucune note ou commentaire pour cette vente.</p>
                        @endif
                    </div>
                </div>
            </div>
