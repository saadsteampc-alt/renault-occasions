...
<head>
    ...
    <title>RenaultOcaz - Validation des Paiements</title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="container container-main">
        <h1 class="page-title">Validation des Paiements</h1>
        
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-search"></i> Rechercher un paiement
                    </div>
                    <div class="card-body">
                        <form action="{{ route('financier.paiements.search') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="code_recue" class="form-label">Code reçu *</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-upc-scan"></i></span>
                                    <input type="text" class="form-control @error('code_recue') is-invalid @enderror" 
                                           id="code_recue" name="code_recue" 
                                           value="{{ old('code_recue', request('code')) }}" 
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Information:</strong> Le code reçu se trouve sur le document PDF fourni par le vendeur.
                        </div>
                    </div>
                </div>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-clock-history"></i> Paiements récents en attente
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($recentVentes as $vente)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="?code={{ $vente->code_recue }}" class="btn btn-primary btn-sm">
                        ...
                        @else
                            <p class="text-center text-muted">Aucun paiement en attente</p>
                        @endif
                    </div>
                </div>
            </div>
