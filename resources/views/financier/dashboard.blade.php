...
<head>
    ...
    <title>RenaultOcaz - Tableau de bord Financier</title>
    <!-- Fonts -->
    ...
    <div class="container container-main">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="stats-card bg-warning">
                    <h5 class="card-title"><i class="bi bi-clock-history"></i> Paiements en attente</h5>
                    <p class="card-text">{{ $ventesEnAttente }}</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="stats-card bg-success">
                    <h5 class="card-title"><i class="bi bi-cash-stack"></i> Paiements validés</h5>
                    <p class="card-text">{{ $ventesPayees }}</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="stats-card bg-info">
                    <h5 class="card-title"><i class="bi bi-currency-euro"></i> Montant total validé</h5>
                    <p class="card-text">
                        @php
                            $totalPaye = \App\Models\Vente::where('statut_paiement', 'paye')->sum('montant');
                        @endphp
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-clock-history"></i> Paiements en attente de validation
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($recentVentes as $vente)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('financier.paiements.search') }}?code={{ $vente->code_recue }}" class="btn btn-primary btn-sm">
                                                        <i class="bi bi-search"></i> Valider
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        @else
                            <p class="text-center text-muted">Aucun paiement en attente de validation</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-bar-chart"></i> Répartition des Paiements
                    </div>
                    <div class="card-body">
